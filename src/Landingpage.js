    ...
    <div>
      <Mobile>
                ...
                {/* <Link to="/demo">
                  ...
                  <Link to="/demo">
                    ...
                    >
                      <path
                        fill="currentColor"
                        d="M9.502 5.513a.144.144 0 0 0-.202.134V6.65a.5.5 0 0 1-.5.5H2.5v2.9h6.3a.5.5 0 0 1 .5.5v1.003c0 .108.11.176.202.134l3.984-2.933l.042-.028a.147.147 0 0 0 0-.252l-.042-.028zM8.3 5.647a1.144 1.144 0 0 1 1.767-.96l3.994 2.94a1.147 1.147 0 0 1 0 1.946l-3.994 2.94a1.144 1.144 0 0 1-1.767-.96v-.503H2a.5.5 0 0 1-.5-.5v-3.9a.5.5 0 0 1 .5-.5h6.3z"
                      />
                    </svg>
                  </Link>
                {/* </Link> */}
        ...
        <section
          ...
          style={{ background: "rgba(216, 217, 229, 1)", padding: "20px" }}
        >
          <div className="container">
      ...
      <Desktop>
        ...
        <div
          className="row video"
          style={{ background: "rgba(247, 247, 247, 1)", padding: "26px" }}
        >
          <div className="col-lg-12">
            <h2 className="text-center">How It Works</h2>
          </div>
        ...
        <section
          ...
          style={{ background: "rgba(247, 247, 247, 1)", padding: "40px" }}
        >
          <div className="container " data-aos="fade-up">

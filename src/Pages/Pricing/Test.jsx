  ...
  return (
    <div>
      ...
      <div className="flex flex-col justify-center items-center pb-10 mt-4 ">
        ...
        <div className="flex justify-center mt-4" style={{ background: "hsl(53 17% 91% / 1)", border: "hsl(0deg 0.94% 11.08% / 10%)" }}>
          <button
            onClick={() => setActiveButton("monthly")}
            className={`px-4 py-2 rounded-md mr-4 ${activeButton === "monthly"
              ? "bg-black text-white"
          ...
          <button
            ...
            className={`px-4 py-2 rounded-md ${activeButton === "yearly"
              ? "bg-black text-white"
              : "bg-indigo-600 text-dark"
              }`}
          >
              ...
              >
                <div className="p-6">
                  ...
                  <p className="mt-4">
                    ...
                    <span className="text-base font-medium text-gray-500">/per
                      year</span>
                  </p>
                  <p className="mt-1">
                    <span className="text-sm font-default tracking-tight text-gray-700 mr-2">
